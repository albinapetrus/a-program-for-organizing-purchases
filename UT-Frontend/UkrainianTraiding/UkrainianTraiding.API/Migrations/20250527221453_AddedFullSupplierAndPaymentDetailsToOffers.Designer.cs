...
namespace UkrainianTraiding.API.Migrations
{
    ...
    [Migration("20250527221453_AddedFullSupplierAndPaymentDetailsToOffers")]
    partial class AddedFullSupplierAndPaymentDetailsToOffers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UkrainianTraiding.API.Models.Domain.Offer", b =>
                {
                    ...
                    b.Property<string>("PaymentEdrpou")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<string>("PaymentIpn")
                        .HasMaxLength(12)
