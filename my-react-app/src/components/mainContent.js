      ...
      <section>
        ...
        <div className={classes.row}>
          <p className={classes.text}>
            {' '}
            <strong> Новачок у закупівлях?</strong> Дізнайтеся про перші
            кроки{' '}
          </p>
          <ul className={classes.firstStepsInfo}>
            ...
            <div className={classes.first}>
              <FaBuildingUser className={classes.icon} />{' '}
              <Link
                to="/CustomerInfo"
                style={{
                  textDecoration: 'none',
            ...
            <div className={classes.first}>
              <MdOutlinePeopleAlt className={classes.icon} />
              <Link
                to="/PublicInfo"
                style={{
                  textDecoration: 'none',
          ...
          <div className={classes.row1}>
            ...
            <ul className={classes.secondStepsInfo}>
              <div className={classes.second}>
                <BsBuildingCheck className={classes.icon1} />
                <Link
                  to="/ConstructionInfo"
                  style={{
                    textDecoration: 'none',
          ...
          <div className={classes.row1}>
            <div className={classes.flex}>
              ...
              <Link to="/news" style={{ marginBottom: '1em' }}>
                До усіх новин{' '}
              </Link>
              <HiArrowRight className={classes.point} />
            </div>
            <div className={classes.third}>
              <article className={classes.news}>
                <p>14 січня 2025, 12:45</p>
                <Link to="/news1">
                  Новий функціонал: Розширений пошук та фільтрація для
                  Постачальників!
                </Link>
                <p>
                  Ми раді повідомити про запуск оновленого модуля пошуку
                  закупівель! <br /> Тепер постачальники можуть використовувати
                  ще більше критеріїв для точного підбору актуальних тендерів
                </p>
              </article>
              <article className={classes.news1}>
                <p>10 січня 2025, 11:10</p>
                <Link to="/news2">
                  Поради Замовникам: Як створити ефективний запит на закупівлю?
                </Link>
              </article>
              ...
              <article className={classes.news2}>
                ...
                <Link to="/news3">
                  Наша платформа зростає: Вже понад 1000 компаній з нами!
                </Link>
              </article>
            </div>
          </div>
