    ...
    return (
      <div className={classes.step4}>
        ...
        <div className={classes.box}>
            ...
            {role === 'supplier' ? (
            <>
              <h1>Кожного дня більше 11 000 закупівель чекають на пропозиції!</h1>
              <p>Ви успішно зареєстрували та активували кабінет на UkrainianTrading. Час знайти вашу першу закупівлю. </p>
               <Link to="/ProcurementSearch">
              <button > 
                  Перейти до закупівель <IoIosRocket style={{background:"#2070d1"}}/>
              </button>
              </Link>
            </>
            ) : (
              <>
                ...
                <Link to="/newOne">
                <button > 
                    Створити першу закупівлю <IoIosRocket style={{background:"#2070d1"}}/>
                </button>
                </Link>
              </>
            )}
