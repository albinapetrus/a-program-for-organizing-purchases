...
export class auth2 extends Component {
  ...
  handleSubmit = async (e) => {
    ...
    if (!selectedRole || !legalStatus || !fullName || !ipn || !dateOfBirth) {
      this.setState({
        error: "Будь ласка, заповніть всі обов'язкові текстові поля.",
      });
      return;
    }
      ...
      <div className={classes.auth}>
        ...
        <form className={classes.form1} onSubmit={this.handleSubmit}>
          <fieldset className={classes.fieldset}>
            ...
            <label htmlFor="passportPhotoFile" className={classes.styledFile}>
              Завантажити
            </label>
            <input
              type="file"
            ...
            />
            {passportPhoto && (
              <p style={{ background: 'white', color: '#2070d1' }}>
                Обрано файл: {passportPhoto.name}
              </p>
            )}
